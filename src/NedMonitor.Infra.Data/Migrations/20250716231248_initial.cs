        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TraceIdentifier = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true),
                    ...
                    Project_SensitiveDataMasking_MaskValue = table.Column<string>(type: "varchar(30)", nullable: true),
                    ...
                    Environment_MachineName = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false),
                    Environment_EnvironmentName = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false),
                    Environment_ApplicationVersion = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    Environment_ThreadId = table.Column<int>(type: "int", nullable: false),
                    User_Id = table.Column<string>(type: "varchar(100)", nullable: true),
                    User_Name = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    User_Account = table.Column<string>(type: "varchar(150)", nullable: true),
                    User_AccountCode = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: true),
                    User_Document = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: true),
                    User_Email = table.Column<string>(type: "varchar(320)", maxLength: 320, nullable: true),
                    User_TenantId = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: true),
                    User_IsAuthenticated = table.Column<bool>(type: "bit", nullable: false),
                    User_AuthenticationType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    Request_HttpMethod = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
                    Request_RequestUrl = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                    Request_Scheme = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    Request_Protocol = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
                    Request_IsHttps = table.Column<bool>(type: "bit", nullable: false),
                    Request_QueryString = table.Column<string>(type: "nvarchar(1350)", maxLength: 1350, nullable: false),
                    Request_RouteValues = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Request_ClientId = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Request_Headers = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Request_ContentType = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    ...
                    Request_IpAddress = table.Column<string>(type: "varchar(45)", maxLength: 45, nullable: true),
                    Request_UserPlatform_UserAgent = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false),
                    Request_UserPlatform_BrowserName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    Request_UserPlatform_BrowserVersion = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Request_UserPlatform_OSName = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: false),
                    Request_UserPlatform_OSVersion = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Request_UserPlatform_DeviceType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Response_StatusCode = table.Column<int>(type: "int", nullable: false),
                    Response_ReasonPhrase = table.Column<string>(type: "varchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ORM = table.Column<string>(type: "nvarchar(60)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlTemplate = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LogCategory = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
                    ...
                    MemberName = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
